...
tk.Label(m, text="Enter file location to copy data from:").grid(row=0) #workbookcopy, prev e1
tk.Label(m, text="Enter file location to paste data to:" ).grid(row=0, column=2) #workbookpaste, e3
